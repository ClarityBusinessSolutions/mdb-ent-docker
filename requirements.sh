...
mv packages/gosu-amd64 packages/gosu
...
# Mongo 7.0.11 Binaries - x86_64
download_file mongodb-enterprise-mongos.rpm \
              mongodb-enterprise-mongos-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise.rpm \
              mongodb-enterprise-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise-database.rpm \
              mongodb-enterprise-database-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise-server.rpm \
              mongodb-enterprise-server-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise-tools.rpm \
              mongodb-enterprise-tools-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-database-tools.rpm \
              mongodb-database-tools-100.10.0-1.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise-database-tools-extra.rpm \
              mongodb-enterprise-database-tools-extra-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-mongosh.rpm \
              mongodb-mongosh-2.2.9.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS

download_file mongodb-enterprise-cryptd.rpm \
              mongodb-enterprise-cryptd-7.0.11-1.el8.x86_64.rpm \
              https://repo.mongodb.com/yum/redhat/8/mongodb-enterprise/7.0/x86_64/RPMS
